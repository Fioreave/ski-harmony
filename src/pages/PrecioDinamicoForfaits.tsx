  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-16">
        ...
        <section className="py-20 bg-gradient-to-t from-primary via-primary to-primary/50">
          <div className="container-custom text-center">
            <div className="max-w-4xl mx-auto animate-fade-in-up">
              <p className="text-lg text-black-foreground font-medium text-black text-italic">
        ...
        <section className="py-20 bg-gray-400/5">
          <div className="container-custom">
