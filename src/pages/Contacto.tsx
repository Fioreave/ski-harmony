...
const Contacto = () => {
  ...
  const offices = [
    {
      name: "ANDORRA",
      address: "Passeig de l'Arnaldeta de Caboet, 11, 2n 2a, AD700 Escaldes Engordany",
      phone: "+376 862 762"
    },
    {
      name: "BARCELONA", 
      address: "Carrer de l'Apresstadora, 12, entlo 1, 08902 L'Hospitalet de Llobregat - Barcelona",
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-6">
                ¡Tu próxima solución tecnológica está a un solo clic de distancia!
              </h1>
              <p className="text-xl text-muted-foreground mb-8">
                Completa el formulario con tus datos y déjanos guiarte hacia la mejor solución para alcanzar tus metas.
              </p>
            </div>
          </div>
        </section>
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <a href="mailto:info@bdrinformatica.com" className="text-primary hover:underline">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <a href="mailto:soporte@bdrinformatica.com" className="text-primary hover:underline">
                    ...
                    <div className="pt-4">
                      <p className="font-medium mb-3">Nuestras redes sociales:</p>
                  ...
                  {offices.map((office) => (
                    <Card key={office.name}>
                      <CardContent className="p-6">
                        <h4 className="text-lg font-semibold text-primary mb-3">{office.name}</h4>
                        <div className="space-y-2">
                          <div className="flex items-start space-x-2">
