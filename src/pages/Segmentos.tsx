...
import mountainPanorama from "@/assets/img/mountain-panorama.jpg";
          ...
          <div className="container-custom text-center">
            <div className="max-w-2xl mx-auto animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to={"/contacto"}
                  className="btn-demo font-medium text-lg px-8 py-3 bg-primary text-primary-foreground hover:scale-105 transition-all duration-200 rounded-md"
                >
                ...
                <HashLink
                  smooth
                  to="/solucion#core"
                  className="text-lg px-6 py-3 border border-black text-black font-medium hover:bg-primary hover:text-primary-foreground transition-colors rounded-md"
                >
