        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
              Únete a las +35 estaciones que ya han transformado su operación
              con Ski Solution 360
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <Link
                className="py-2 border-black text-black px-8 border-none rounded-lg bg-white text-lg font-medium hover:bg-black hover:text-primary"
                to={"/contacto"}
              >
